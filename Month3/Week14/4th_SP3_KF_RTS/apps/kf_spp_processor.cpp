...
int main() {
	...
	string in_csv = "../../data/trajectory_dualfreq_SP3CLK.csv";
 ...
 */
	...
	ofstream out2("../../data/trajectory_dualfreq_SP3CLK_RTS.csv");
	...
	out2.close();
	cout << "Output: trajectory_dualfreq_SP3CLK_RTS.csv" << endl;

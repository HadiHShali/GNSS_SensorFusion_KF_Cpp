...
struct ObsRecord {
    int prn;
    double pseudorange;   // C1W in m
    double pseudorange_c2 = 0.0;   // C2W in m
    bool has_c2 = false;           // Was C2W present this epoch?
	// New: Carrier Phase fields
	double phase_l1 = 0.0; // L1C, in cycles (not meters -- per day 1)
	double phase_l2 = 0.0; // L2W, in cycles
	bool has_phase_l1 = false;
	bool has_phase_l2 = false;
	int lli_l1 = 0; // loss of lock indicator (0 = OK, nonzero = flagged)
	int lli_l2 = 0;
};
